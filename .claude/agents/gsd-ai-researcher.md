...
<required_reading>
Read `/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
