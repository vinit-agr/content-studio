...
<reference>
@/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/references/user-profiling.md` to load:
