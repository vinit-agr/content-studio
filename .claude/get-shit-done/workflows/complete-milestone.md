...
```bash
node "/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/templates/retrospective.md`.
