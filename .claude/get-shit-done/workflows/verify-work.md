...
<template>
@/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/workflows/diagnose-issues.md
