...
```
Task(
  prompt="Read /Users/vinit/Tars/Content-Creation/content-studio/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/templates/SECURITY.md`
