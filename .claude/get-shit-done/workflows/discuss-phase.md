...
<required_reading>
@/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/references/domain-probes.md
@/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/references/gate-prompts.md
@/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @/Users/vinit/Tars/Content-Creation/content-studio/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/workflows/discuss-phase-power.md
