...
```bash
INIT=$(node "/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/templates/spec.md.
