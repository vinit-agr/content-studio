...
- **Global scope**: `/Users/vinit/Tars/Content-Creation/content-studio/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/vinit/Tars/Content-Creation/content-studio/.claude/notes/`)
...
2. Glob `/Users/vinit/Tars/Content-Creation/content-studio/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/vinit/Tars/Content-Creation/content-studio/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/vinit/Tars/Content-Creation/content-studio/.claude/notes/` — works in any directory
