...
- Usage: Reference from command with `@/Users/vinit/Tars/Content-Creation/content-studio/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/vinit/Tars/Content-Creation/content-studio/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/vinit/Tars/Content-Creation/content-studio/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
